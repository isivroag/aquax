...
if (!empty($_GET['id']) && empty($_POST['btnGuardar'])) {
    $user = new Visitante();
    if ($user->buscarVisitante($_GET['id'])) {

        $nombre = $user->getNombre();
        $ine = $user->getIne();
        $licencia = $user->GetLicencia();
    ...
    if (isset($_POST['btnGuardar'])) {
        ...
        if (!empty($_POST['nombre']) && (!empty($_POST['ine'])  || !empty($_POST['pasaporte']) || !empty($_POST['licencia']) || !empty($_POST['otro']))) {
            ...
            if ($user->actVisitante($_GET['id'], $nombre, $ine,  $licencia, $pasaporte, $otro,$foto)) {
