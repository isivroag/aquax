...
if (isset($_POST['btnGuardar'])) {
    ...
    if ( !empty($_POST['nom_oficina']) && !empty($_POST['titular_oficina']) ) {
        ...
        if ($Oficina->saveOficina($nom_oficina, $titular_oficina)) {
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-gradient-primary">
                <h5 class="modal-title" id="exampleModalLabel">Alta de Oficinas</h5>
            ...
            <form id="formPersonas" action="" method="POST">
                <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="nom_oficina" class="col-form-label">Numero de Oficina:</label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="textarea" class="form-control" name="titular_oficina" id="titular_oficina">
                        </div>
